...
def generate_irregular_samples(data, input_dim):
    ...
    for i in range(data.shape[0]):
        ...
        #print(f"Sample {i} - Current Length: {curr_len}, Values shape: {values.shape}, Times shape: {times.shape}, Mask shape: {mask.shape}")
